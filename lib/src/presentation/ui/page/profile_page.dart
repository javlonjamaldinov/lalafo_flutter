...
import 'package:lalafo_flutter/src/presentation/settings/edit_profile.dart';
import 'package:lalafo_flutter/src/presentation/settings/settings_profile.dart';
import 'package:lalafo_flutter/src/presentation/ui/details/my_content.dart';
          ...
          children: [
            Padding(
              padding: EdgeInsets.only(
                  top: screenSize.height * 0.05, left: screenSize.width * 0.06),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const CircleAvatar(
